...
export default function RoleCreateScreen({ navigation }) {
  ...
  const handleCreate = () => {
    if (!roleName.trim()) {
      Alert.alert('Thiếu thông tin', 'Vui lòng nhập tên vai trò.');
      return;
    }
    Alert.alert('Thành công', `Đã tạo vai trò mới: "${roleName}"`);
    navigation.goBack();
  };
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        >
          <Text style={styles.title}>Tạo vai trò mới</Text>
        ...
        {/* 🔹 Nút tạo vai trò cố định dưới đáy */}
        <View style={styles.fixedButtonContainer}>
          <TouchableOpacity style={styles.updateButton} onPress={handleCreate}>
            <Text style={styles.updateText}>Tạo vai trò</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
